...
function getToken() {
  return sessionStorage.getItem('estoka_token') || localStorage.getItem('estoka_token');
}
function setLoading(v) { $('#globalLoader').hidden = !v; }

function clearTokenEverywhere() {
  sessionStorage.removeItem('estoka_token'); sessionStorage.removeItem('estoka_token_expires');
  localStorage.removeItem('estoka_token'); localStorage.removeItem('estoka_token_expires');
}
